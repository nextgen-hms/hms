...
name: readme
description: >
  Use when the user wants to create or update a README.md file for a project.
  Also use when the user says "write readme," "create readme," "document this
  project," "project documentation," or asks for help with README.md. This
  skill creates thorough documentation covering local setup, architecture, and
  deployment.
