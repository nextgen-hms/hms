...
\restrict pk8go97SCD4Ix2RqeLXub9Gz2xSiPfTJRxQreAwTq8NWFOD3oaG4ziDgBbJXfHt
...
begin
	if new.txn_type = 'purchase' then 
	 ...
	 if TG_OP = 'INSERT' then
   update medicine 
   set stock_quantity = stock_quantity + (v_sign *new.qty)
...
\unrestrict pk8go97SCD4Ix2RqeLXub9Gz2xSiPfTJRxQreAwTq8NWFOD3oaG4ziDgBbJXfHt
